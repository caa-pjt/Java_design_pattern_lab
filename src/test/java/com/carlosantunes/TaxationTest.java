...
public class TaxationTest {
    ...
    public void testCalculerTaxePrive() {
        ...
        Table tablePrivee = new Table("Client 1", new Date(), TableType.PLAISIR);
        ...
        tablePrivee.setTaxation(new TaxationPrive());
    ...
    public void testCalculerTaxeEntreprise() {
        ...
        Table tableEntreprise = new Table("Client 2", new Date(), TableType.VEGAN);
